...
def generate_text_report():
    try:
        ...
        for functionDetails in functionsDetails:
            print(functionDetails)
            functionId = int(functionDetails["id"])
            domain = int(functionDetails["domain"])
            dimension = int(functionDetails["dimension"])
            ...
            TESTS = 10
            goa_algorithm.calculate_function_data(test_function, [0.34, 0.88], TESTS, data)
